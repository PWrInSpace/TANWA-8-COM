...
esp_err_t board_config_init(void) {
    ...
    //relay_open(&(tanwa_hardware.relay[3])); //VENT
    ...
    // uint8_t data_stop[8] = {0};
    // can_send_message(CAN_SOL_SERVO_OPEN_ID, data_stop, 3);
    // uint8_t data_fuel[8] = {0};
    // data_fuel[0] = 1;
    // can_send_message(CAN_SOL_SERVO_OPEN_ID, data_fuel, 3);
